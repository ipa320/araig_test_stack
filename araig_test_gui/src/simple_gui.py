...
class App(MDApp):
    ...
    def __init__(self, **kwargs):
        ...
        rospy.Subscriber('/bool_1', BoolStamped, self.callback_test_completed)
        rospy.Subscriber('/bool_2', BoolStamped, self.callback_test_failed)
        rospy.Subscriber('/bool_3', BoolStamped, self.callback_test_succeeded)
    ...
    def callback_float_1(self, msg):
        ...
        self.root.ids['result1_v_label'].text = str(msg.data)

    def callback_float_2(self, msg):
       
        self.root.ids['result2_v_label'].text = str(msg.data)
    ...
    def callback_test_completed(self, msg):
        ...
        if self.completed == True:
            print('it became true')
            self.root.ids['led_typeboth1'].set_on()
    ...
    def callback_test_failed(self, msg):
        ...
        if self.failed == True:
            self.root.ids['led_typeboth2'].set_on()
    ...
    def callback_test_succeeded(self, msg):
        ...
        if self.suceeded == True:
            self.root.ids['led_typeboth3'].set_on()
