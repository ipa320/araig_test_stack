...
class TestCompParam(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.pose_tolerance = rospy.get_param(
            "/calculators/comp_poses_node/pose_tolerance")
        self.orientation_tolerance = rospy.get_param(
            "/calculators/comp_poses_node/orientation_tolerance")
        self.result = None
